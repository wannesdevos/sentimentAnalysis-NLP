...
with gr.Blocks(title="Sentiment Analysis") as demo:
    ...
    gr.Examples(
        examples=[
            ["This movie was absolutely fantastic! Best film I've seen this year.", "Model 1 - DistilBERT (Fast)"],
            ["Terrible movie, waste of time and money.", "Model 1 - DistilBERT (Fast)"],
            ["The acting was decent but the plot was confusing.", "Model 2 - RoBERTa Large (Accurate)"],
        ],
